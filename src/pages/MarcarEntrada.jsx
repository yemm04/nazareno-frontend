        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          {isAdmin && (
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
              ...
              <p className="text-sm text-gray-400 mb-3">Busca a la persona y registra su entrada.</p>
