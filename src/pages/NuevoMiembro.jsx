...
export default function NuevoMiembro() {
  ...
  return (
    <>
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-1">Nuevo Miembro</h1>
      <p className="text-sm text-gray-400 mb-6">Completa la ficha del practicante o coordinador.</p>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 max-w-3xl space-y-8">
        ...
        <section>
          ...
          <p className="text-sm text-gray-400 mb-4">Rol, área y fecha de ingreso — de aquí sale el código de acceso.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Rol *">
              <select value={form.rol} onChange={handleChange('rol')} className={inputClass}>
            ...
            <Field label="Fecha de Ingreso *"><input type="date" value={form.fechaIngreso} onChange={handleChange('fechaIngreso')} className={inputClass} /></Field>
          </div>
        </section>
        ...
        <div className="flex justify-end gap-3 pt-2 border-t border-gray-100">
          ...
          <button type="submit" className="bg-purple-950 hover:bg-purple-900 text-white text-sm font-semibold px-5 py-2.5 rounded-lg">
            Registrar Miembro
          </button>
        </div>
      </form>
